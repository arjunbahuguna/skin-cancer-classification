#NEED TO EDIT THIS CODE, MAKE IT SMALLER AND PERSONALIZED OR WE WILL BE SUED FOR COPYING CODE
#LOL
...
The top layer receives as input a 

#2048-dimensional vector (1001-dimensional for
